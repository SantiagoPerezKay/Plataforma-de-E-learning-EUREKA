...
public class EnrollmentController {
    ...
    public ResponseEntity<List<EnrollmentDto>> findAllByStudent(@PathVariable Long studentId){
        return ResponseEntity.ok(this.enrollmentService.findAllByStudent(studentId));
    }
}
