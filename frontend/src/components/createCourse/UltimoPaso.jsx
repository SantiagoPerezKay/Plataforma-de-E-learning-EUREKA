...
function UltimoPaso() {
    ...
    return (
        <div className="w-[90%] mx-auto border shadow rounded-md py-5 px-5 bg-slate-200">
            {
                submit ? 
                    <div className='flex flex-col justify-center gap-4 bg-white py-5 rounded-lg'>
                ...
                :
                    <div className='flex flex-col justify-center gap-8 bg-white py-5 rounded-lg'>
